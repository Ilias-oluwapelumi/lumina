...
async function seed() {
  ...
  await User.create({ id, fullName: 'Tobi Johnson', email: 'tobi@lumina.ng', phone: '08012345678', passwordHash, kycTier: 3, kycVerified: true });
  await Wallet.create({ userId: id, balance: 250000, accountNumber: '8012345678', bankName: 'Lumina Bank' });
